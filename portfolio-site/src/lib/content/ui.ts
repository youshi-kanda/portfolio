...
export const ui = {
  /*
   * `mobileIndex` IS GONE, not renamed.
   *
   ...
   *
   * Its row is removed from ui.json in the same change; a registry row for a
   * string nothing renders is what U-ORPHAN exists to refuse.
   */
  nav: {
    /**
